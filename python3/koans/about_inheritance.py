...
class AboutInheritance(Koan):
    ...
    class Chihuahua(Dog):
        '''
        inherits the method of get_name property
        '''
        def wag(self):
            return "happy"
    ...
    def test_base_init_does_not_get_called_automatically(self):
        '''
        if you explicitly declare init in a Python class you have to call super().__init__(arg)
        otherwise you get an Exception. If you don't have it then you will just inherit the superclass __init__
        '''
