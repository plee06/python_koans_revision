...
class AboutAttributeAccess(Koan):
    ...
    def test_all_attribute_reads_are_caught(self):
        '''
        we can catch bad attribute reads by redefining __getattribute__!
        '''
    ...
    def test_intercepting_return_values_can_disrupt_the_call_chain(self):
        ...
        self.assertRegex(err_msg, "'str' object is not callable") # exception is a string, thus not calalble with args
    ...
    def test_getattribute_is_a_bit_overzealous_sometimes(self):
        ...
        catcher.my_method() # uses __getattribute__ and calls it within the class!
        global stack_depth
    ...
    def test_getattr_only_catches_unknown_attributes(self):
        ...
        self.assertEqual("DuffObject",
            type(catcher.give_me_duff_or_give_me_death()).__name__) # returns DuffObject because of how __getattr__ is defined above
