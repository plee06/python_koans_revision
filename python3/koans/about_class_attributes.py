...
class AboutClassAttributes(Koan):
    ...
    class Dog2:
        ...
        @classmethod # singleton method for classes
        def growl(cls):
    ...
    def test_classmethods_are_not_independent_of_instance_methods(self):
        fido = self.Dog2()
        '''
        class singleton method will override the instance method in Python 
        '''
    ...
    def test_staticmethods_are_unbound_functions_housed_in_a_class(self):
        '''
        unbound == static. not attached to any instance.
        :return:
        '''
    ...
    def test_classmethods_can_not_be_used_as_properties(self):
        '''
        violates whole props rule. properties should be at the instance level not the class level!
        the
        '''
        fido = self.Dog3()
    ...
    def test_classes_and_instances_do_not_share_instance_attributes(self):
        '''
        here what we do is set an isntance name of Fido. Then set a class attribute to Rover.
        So Rover is now the class attribute of name, and Fido is the instance attribute.
        '''
        fido = self.Dog3()
    ...
    def test_classes_and_instances_do_share_class_attributes(self):
        '''
        so if we set a class attribute on a class. that is shared amongst all instance and same as class!
        '''
        fido = self.Dog3()
        fido.set_name("Fido")
